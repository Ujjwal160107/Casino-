...
exports.setupDrop = void 0;
const discord_js_1 = require("discord.js");
const prisma_1 = __importDefault(require("../../utils/prisma"));
const setupDrop = async (message, args) => {
    ...
    if (type === "SCHEDULED") {
        if (!param || !/^\d{2}:\d{2}$/.test(param))
            return message.reply("Invalid time format. Use HH:MM (24h).");
        data.type = "SCHEDULED";
        ...
        if (isNaN(minutes))
            return message.reply("Invalid interval minutes.");
        data.type = "INTERVAL";
        ...
        if (isNaN(count))
            return message.reply("Invalid message count.");
        ...
        if (isNaN(minI) || isNaN(maxI))
            return message.reply("Invalid interval range. Use `min-max`.");
        data.type = "RANDOM";
    ...
    try {
        await prisma_1.default.casinoDropConfig.create({ data });
...
exports.setupDrop = setupDrop;
//# sourceMappingURL=setupDrop.js.map