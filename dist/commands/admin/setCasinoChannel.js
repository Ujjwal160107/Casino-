...
exports.handleSetCasinoChannel = handleSetCasinoChannel;
const discord_js_1 = require("discord.js");
const guildConfigService_1 = require("../../services/guildConfigService");
const embed_1 = require("../../utils/embed");
const permissionUtils_1 = require("../../utils/permissionUtils");
async function handleSetCasinoChannel(message, args) {
    ...
    if (!channel || channel.type !== discord_js_1.ChannelType.GuildText) {
        ...
        if (args[0]?.toLowerCase() === "clear") {
            ...
            return message.reply({
                embeds: [(0, embed_1.successEmbed)(message.author, "Configuration Updated", "Cleared all designated casino channels.")]
            });
        }
    ...
    if (channels.includes(channel.id)) {
        ...
        await (0, guildConfigService_1.updateGuildConfig)(message.guildId, { casinoChannels: channels });
        return message.reply({
            embeds: [(0, embed_1.successEmbed)(message.author, "Configuration Updated", `Removed ${channel.toString()} from casino channels.`)]
        });
    }
    else {
        ...
        await (0, guildConfigService_1.updateGuildConfig)(message.guildId, { casinoChannels: channels });
        return message.reply({
            embeds: [(0, embed_1.successEmbed)(message.author, "Configuration Updated", `Added ${channel.toString()} to designated casino channels.`)]
        });
    }
}
//# sourceMappingURL=setCasinoChannel.js.map