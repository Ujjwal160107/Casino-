...
exports.getWorkGame = getWorkGame;
...
function getWorkGame() {
    ...
    if (rand < 0.60)
        return generateTriviaGame();
    if (rand < 0.75)
        return generateReverseTypingGame();
...
function generateReverseTypingGame() {
...
//# sourceMappingURL=minigameService.js.map