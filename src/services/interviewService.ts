...
const DEGREE_QUESTIONS: Record<string, Question[]> = {
    "Computer Science": [
...
export function getInterview(sector: string): { questions: Question[] } {
    // 4 Random General
    ...
    let degreeKey = "";
    if (sector === "tech") degreeKey = "Computer Science";
    else if (sector === "medical") degreeKey = "Medicine";
    else if (sector === "business") degreeKey = "Business";
    else if (sector === "legal") degreeKey = "Law";
    else if (sector === "service") degreeKey = "Culinary Arts";
    else if (sector === "trade") degreeKey = "Trade";
