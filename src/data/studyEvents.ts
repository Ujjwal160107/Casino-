...
export const STUDY_EVENTS: StudyEvent[] = [
    ...
    },
    {
        ...
        description: "A classmate challenged you to a debate on the topic. The professor is watching.",
        outcome: "random",
        successChance: 50,
        xpMod: 50,
        stressMod: 10,
    ...
    // Law
    {
        ...
        description: "You won your moot court round with a brilliant closing argument.",
        outcome: "success",
        xpMod: 50,
        stressMod: -5,
    },
    {
        ...
        description: "You cited a case that was overturned. The professor made an example of you.",
        outcome: "failure",
        xpMod: -40,
        stressMod: 20,
    },
    ...
    },
    {
        ...
        description: "You applied the wrong jurisdiction's precedent in your analysis.",
        outcome: "failure",
        xpMod: -40,
        stressMod: 15,
    },
