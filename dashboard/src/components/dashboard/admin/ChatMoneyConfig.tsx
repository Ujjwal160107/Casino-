...
export function ChatMoneyConfig({ guildId, config }: ChatMoneyConfigProps) {
    ...
    return (
        <div className="space-y-8">
            <div className="glass-card border border-white/5 rounded-xl p-6 space-y-6">
                ...
                <div className="space-y-4 pt-4 border-t border-white/5">
                    ...
                    <div className="flex gap-2">
                        <input
                            ...
                            className="flex-1 bg-white/5 border border-white/10 rounded-lg px-4 py-2.5 text-white font-mono"
                    ...
                    <div className="space-y-2">
                        {formData.channels.map(id => (
                            <div key={id} className="flex items-center justify-between bg-white/5 p-3 rounded-lg border border-white/5">
