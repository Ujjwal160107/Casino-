    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm overflow-y-auto">
            ...
            >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                        ...
                        <div className="md:col-span-8 space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-slate-950/50 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/20 transition-all font-medium placeholder:text-slate-700"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-slate-950/50 border border-white/10 rounded-lg pl-8 pr-4 py-3 text-white focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/20 transition-all font-mono placeholder:text-slate-700"
                                            placeholder="0"
                                        />
                                    </div>
                                </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    ...
                                    className="w-full bg-slate-950/50 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/20 transition-all resize-none min-h-[100px] placeholder:text-slate-700"
                        ...
                        <div className="md:col-span-4 space-y-6">
                            <div className="glass-card p-5 rounded-xl space-y-4">
                                <div className="flex gap-4">
                                    <div className="space-y-2 flex-1">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-slate-950/50 border border-white/10 rounded-lg px-3 py-2 text-center text-xl focus:outline-none focus:border-primary/50 transition-all"
                                            placeholder="🎫"
                                            maxLength={4}
                                        />
                                    </div>
                                    <div className="space-y-2 flex-1">
                                        ...
                                        <div className="h-[42px] bg-slate-950/50 border border-white/10 rounded-lg flex items-center justify-center">
                                            {formData.image ? (
                                                <img src={formData.image} className="h-6 w-6 object-contain" />
                                            ) : (
                                                <span className="text-slate-700 text-xs">No Img</span>
                                            )}
                                        </div>
                                    </div>
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-slate-950/50 border border-white/10 rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-primary/50 transition-all placeholder:text-slate-700 truncated"
                                        placeholder="https://..."
                                    />
                                </div>
                            </div>
                            ...
                            <div className="glass-card p-4 rounded-xl flex items-center justify-between">
                                <div>
                                    <label className="text-[10px] font-bold text-slate-400 uppercase block">Stock</label>
                                    <span className="text-xs text-slate-400">{formData.stock === -1 ? "Unlimited" : formData.stock}</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <button
                                        onClick={() => handleChange("stock", formData.stock === -1 ? 0 : -1)}
                                        className={`px-2 py-1 rounded text-[10px] font-bold border transition-all ${formData.stock === -1 ? "bg-primary/20 text-primary border-primary/30" : "bg-slate-800 text-slate-500 border-white/5"}`}
                                    >
                                        ∞
                                    </button>
                                    {formData.stock !== -1 && (
                                        <input
                                            ...
                                            className="w-16 bg-slate-950/50 border border-white/10 rounded px-2 py-1 text-sm text-right focus:outline-none focus:border-primary/50"
                                        />
                                    )}
                                </div>
                            </div>
                        ...
                        <div className="space-y-4">
                            <div className="flex justify-between items-center">
                                ...
                                <div className="relative group">
                                    <button className="text-xs bg-white/5 hover:bg-white/10 border border-white/10 px-3 py-1.5 rounded-full text-slate-300 transition-all flex items-center gap-1">
                                    ...
                                    >
                                        <option value="" className="bg-slate-900">+ Add</option>
                                        <option value="ROLE" className="bg-slate-900">Role</option>
                                        <option value="ITEM" className="bg-slate-900">Item</option>
                                        <option value="BALANCE" className="bg-slate-900">Balance</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div className="glass-card p-1 min-h-[200px] rounded-xl flex flex-col gap-2">
                                ...
                                {formData.requirements?.roles?.map((roleId: string, idx: number) => (
                                    <div key={`param-role-${idx}`} className="bg-white/5 border border-white/5 p-3 rounded-lg flex items-center gap-3 group">
                                        ...
                                        <div className="flex-1">
                                            <label className="text-[10px] font-bold text-slate-500 uppercase block">Required Role</label>
                                        ...
                                        <button onClick={() => {
                                            ...
                                            handleReqChange("roles", newRoles);
                                        }} className="opacity-0 group-hover:opacity-100 p-1 hover:bg-white/10 rounded transition-all text-slate-400 hover:text-red-400">
                                            <X size={14} />
                                        </button>
                                    </div>
                                ))}
                                ...
                                {formData.requirements?.balance > 0 && (
                                    <div className="bg-white/5 border border-white/5 p-3 rounded-lg flex items-center gap-3 group">
                                        ...
                                        <div className="flex-1">
                                            <label className="text-[10px] font-bold text-slate-500 uppercase block">Min Balance</label>
                                            <input
                                                type="number"
                                        ...
                                        <button onClick={() => handleReqChange("balance", 0)} className="opacity-0 group-hover:opacity-100 p-1 hover:bg-white/10 rounded transition-all text-slate-400 hover:text-red-400">
                                            <X size={14} />
                                        </button>
                                    </div>
                                )}
                            ...
                            <div className="glass-card p-1 min-h-[200px] rounded-xl flex flex-col gap-2 relative">
                                ...
                                {formData.effects?.map((effect: any, idx: number) => (
                                    <div key={idx} className="bg-white/5 border border-white/5 rounded-lg overflow-hidden group">
                                        {/* Effect Header */}
                                        <div className="flex items-center gap-3 p-3 bg-slate-900/40 border-b border-white/5">
                                            ...
                                            <div className="relative">
                                                <select
                                                    ...
                                                    className="appearance-none bg-transparent text-[10px] uppercase font-bold text-slate-400 focus:text-white focus:outline-none cursor-pointer pr-4 hover:bg-white/5 rounded px-1"
                                                >
                                                    <option value="BUY" className="bg-black">On Purchase</option>
                                                    <option value="USE" className="bg-black">On Use</option>
                                                </select>
                                                <ChevronDown size={10} className="absolute right-0 top-1/2 -translate-y-1/2 text-slate-600 pointer-events-none" />
                                            </div>
                                            ...
                                            <button onClick={() => removeEffect(idx)} className="text-slate-600 hover:text-red-400 transition-colors">
                                                <X size={14} />
                                            </button>
                                        </div>
                                        ...
                                        <div className="p-3 bg-slate-950/20">
                                            {effect.type === "CUSTOM_MESSAGE" && (
                                                <input
                                                    ...
                                                    className="w-full bg-transparent border-b border-white/10 text-sm py-1 focus:outline-none focus:border-primary/50 text-slate-300 placeholder:text-slate-700"
                                                />
                                            )}
                                                ...
                                                <div className="flex flex-col gap-3">
                                                    <div>
                                                        ...
                                                        <select
                                                            ...
                                                            className="w-full bg-slate-900/50 border border-white/10 rounded px-3 py-2 text-sm text-white focus:outline-none focus:border-primary/50 transition-colors"
                                                        >
                                                            <option value="" className="bg-black">Select Role...</option>
                                                            {roles.map(r => <option key={r.id} value={r.id} className="bg-black">{r.name}</option>)}
                                                        </select>
                                            ...
                                            {["MONEY", "XP_MULTIPLIER", "PAY_MULTIPLIER"].includes(effect.type) && (
                                                <div className="flex items-center gap-2">
                                                    <span className="text-xs text-slate-500 uppercase font-bold">Amount / Multi</span>
                                                    <input
                                                        type="number"
                                                        ...
                                                        className="flex-1 bg-transparent border-b border-white/10 text-sm py-1 focus:outline-none text-slate-300 font-mono"
                                                        placeholder="0"
                                                    />
                                                </div>
                                            )}
                ...
                {/* Footer Controls */}
                <div className="px-8 py-5 border-t border-white/10 bg-slate-900/80 flex justify-between items-center backdrop-blur-md">
                    <div className="flex items-center gap-4">
                        <label className="flex items-center gap-2 cursor-pointer group">
                            <div className={`w-10 h-6 rounded-full p-1 transition-colors ${formData.showInInventory ? "bg-primary" : "bg-slate-700"}`} onClick={() => handleChange("showInInventory", !formData.showInInventory)}>
                                <div className={`w-4 h-4 bg-white rounded-full transition-transform ${formData.showInInventory ? "translate-x-4" : ""}`} />
                            </div>
                            <span className="text-xs font-bold text-slate-400 group-hover:text-white transition-colors uppercase">Show in Inventory</span>
                        </label>

                        <label className="flex items-center gap-2 cursor-pointer group">
                            <div className={`w-10 h-6 rounded-full p-1 transition-colors ${formData.usable ? "bg-primary" : "bg-slate-700"}`} onClick={() => handleChange("usable", !formData.usable)}>
                                <div className={`w-4 h-4 bg-white rounded-full transition-transform ${formData.usable ? "translate-x-4" : ""}`} />
                            </div>
                            <span className="text-xs font-bold text-slate-400 group-hover:text-white transition-colors uppercase">Usable Item</span>
                        </label>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button
                            onClick={handleSave}
                            disabled={isSaving}
                            className="bg-primary hover:brightness-110 text-primary-foreground px-8 py-2.5 rounded-lg font-bold shadow-lg shadow-primary/25 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                        >
