...
const jobsAndCareers: ModuleDoc = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        "Every job, its pay per shift, and what the posting demands. XP is job XP earned by working shifts (+10 per success); degrees come from the Education module; ladder jobs also require the previous rung.",
      ],
      table: {
        title: "All 21 jobs",
        columns: ["Job", "Sector", "Tier", "Pay/shift", "Job XP", "Degree", "Previous job"],
        rows: [
          ["Waiter", "Service", "0", "32,000", "—", "—", "—"],
          ["Sous Chef", "Service", "0", "45,000", "100", "—", "Waiter"],
          ...
          ["Master Mechanic", "Trade", "2", "90,000", "150", "Trade License", "Apprentice Mechanic"],
          ["Financial Analyst", "Business", "2", "120,000", "50", "BA Fine Arts", "—"],
          ["Junior Developer", "Tech", "2", "130,000", "50", "BS Computer Science", "—"],
          ["Paralegal", "Legal", "2", "140,000", "20", "LLB", "—"],
          ["Medical Resident", "Medical", "2", "150,000", "—", "MBBS", "—"],
          ["Sales Manager", "Business", "3", "180,000", "150", "BA Fine Arts", "Financial Analyst"],
          ["Senior Developer", "Tech", "3", "210,000", "150", "BS Computer Science", "Junior Developer"],
          ["General Practitioner", "Medical", "3", "220,000", "50", "MBBS", "Medical Resident"],
          ["Associate Attorney", "Legal", "3", "260,000", "150", "LLB", "Paralegal"],
          ["Surgeon", "Medical", "3", "320,000", "150", "MBBS + MD/PhD", "General Practitioner"],
          ["Lead Engineer", "Tech", "4", "280,000", "300", "BS Computer Science", "Senior Developer"],
          ["Partner", "Legal", "4", "400,000", "500", "LLM", "Associate Attorney"],
          ["Chief of Medicine", "Medical", "4", "450,000", "500", "MBBS + MD/PhD", "Surgeon"],
        ],
      },
    ...
    },
    {
      ...
      body: [
        "!work → Start Shift, once per hour. About 70% of shifts are a quick minigame — word scrambles, memory, typing, trivia, emoji math. Win: full pay, +10 job XP, +5 stress. Lose (or time out): nothing, −5 XP, +10 stress, and the cooldown is spent either way.",
        "The other 30% are workplace events: a scenario with choices, each carrying hidden odds, a pay multiplier from 0.3× to 3×, XP up to +100, and stress. Some choices are marked critical — failing those hurts, unless an Emergency Pager (600,000) softens the blow. An Overtime Contract raises the event chance to 60% and clears your cooldown to boot.",
    ...
    },
    {
      ...
      body: [
        "Promotions are automatic eligibility: hit the next rung's XP requirement and a Promote button appears on !work. Your XP and stress carry over. !career tracks your shift success rate (S rating at 95%+), earnings, and reputation tier.",
        "The ladder runs both ways: three consecutive failed shifts demote you to the previous rung. Entry-level jobs can't be demoted, and any success — or an Emergency Pager save — resets the failure streak. A Black Market Resume (900,000) gambles on the climb: 65% for +50–150 XP, 35% to backfire.",
      ],
    },
    {
      heading: "Career tier: the credit card key",
      body: [
        "Every job carries a career tier, 0–4, and card tiers demand it alongside credit score: GOLD needs tier 2, PLATINUM tier 3, BLACK tier 4. Tier 2 is the cheapest gate to reach — Paralegal (LLB, 20 XP) or Master Mechanic (Trade License) — while tier 4 means topping the Tech, Legal, or Medical ladder.",
      ],
    },
    {
      ...
      body: [
        ...
        "Front-load education. The XP walls (150 for tier 3, 300–500 for tier 4) take dozens of shifts; the degree takes an afternoon of studying. Get the degree first so a promotion is waiting the day you clear the XP, not a semester later.",
        "Consumables beat idle time: Energy Flask (−2h cooldown) and Overtime Contract effectively add shifts to your day, and Focus Headphones' 2× XP for 3 shifts halves the grind to the next rung. On event shifts, take the safe option when a multiplier is 1×–1.5× and gamble only when the downside isn't marked critical.",
      ],
    },
  ],
  ...
  proTips: [
    ...
    "Medical Resident needs zero job XP — with an MBBS you jump straight to 150,000 a shift and career tier 2, skipping the intern grind entirely.",
