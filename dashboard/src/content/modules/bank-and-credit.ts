  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "Cardholders get one DM every Monday covering both halves of the cycle: last week's outcome (paid in full +30, minimum paid +20, or missed −45/−60 with the score change, any interest added, and your card's new status) and this week's new statement (balance, minimum due, and due date) — skipped only when the statement is zero and nothing settled. Toggle it off under !settings (Account notices → Card statements).",
      ],
